...
class SkeletalModel
{
  public:
    ...
    void _computeBindWorldToJointTransforms(Joint *j, Matrix4f m); 

    void _updateCurrentJointToWorldTransforms(Joint *j, Matrix4f m);
